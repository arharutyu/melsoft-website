...
const Services = () => {
    return (
        <>
            ...
            <div className="services-area bg-f7fafd" id="set-up">
                        ...
                        <div className="col-lg-6 col-md-12 services-content">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="box">
                                        <div className="section-title"><h3>Theme Implementation</h3></div>
                                        We transform your vision into reality by implementing pre-built themes on WordPress or using JavaScript for a dynamic touch.
                                    </div>
                                </div>

                                <div className="col-lg-6">
                                    <div className="box">
                                    <div className="section-title"><h3>Customization</h3></div>

                                    Tailor your website with additional CSS/JavaScript customization to make the website uniquely yours.
                                    </div>
                                </div>

                                <div className="col-lg-6">
                                    <div className="box">
                                    <div className="section-title"><h3>Cloud Deployment</h3></div>
                                    Experience the power of the cloud with seamless deployment on AWS or your preferred cloud platform.
                                    </div>
                                </div>

                                <div className="col-lg-6">
                                    <div className="box">
                                    <div className="section-title"><h3>Domain Assistance</h3></div>
                                    Need a custom domain? We've got you covered. Once your domain is secured, we seamlessly integrate it with your website, handling all technical configurations. 
                                    </div>
                                </div>
            ...
            <div className="services-area ptb-80" id="spruik-up">
                <div className="container">
                    <div className="row h-100 justify-content-center align-items-center">
                        ...
                        <div className="section-title">
                                <h2>Spruik Up</h2>
                                <div className="bar"></div>
                                <p>Breathe New Life Into Your Existing Site</p>
                            </div>

                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="box">
                                        <div className="section-title"><h3>Complete Makeover</h3></div>
                                        Outdated theme? We give your website a fresh, contemporary look.
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="box">
                                        <div className="section-title"><h3>Problem Spot Identification</h3></div>
                                        We pinpoint and fix any issues, ensuring a smooth user experience.
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="box">
                                        <div className="section-title"><h3>Cloud Hosting Transition</h3></div>
                                        Upgrade to managed hosting on AWS or your chosen cloud platform for enhanced performance.
                                    </div>
                                </div>
